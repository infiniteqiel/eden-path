/**
 * Simple Business Switcher Component
 * 
 * Dropdown to select between user's businesses - companies only, no "Add Company" option.
 */
...
interface SimpleBusinessSwitcherProps {
  businesses: Business[];
...
export function SimpleBusinessSwitcher({ 
  businesses, 
  currentBusiness, 
  onBusinessChange,
  disabled = false
}: SimpleBusinessSwitcherProps) {
  return (
    <DropdownMenu>
