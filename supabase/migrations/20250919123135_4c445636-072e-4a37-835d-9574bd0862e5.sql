...
-- Drop existing text embedding column and create proper vector column
ALTER TABLE knowledge_base_documents DROP COLUMN IF EXISTS embedding;
ALTER TABLE knowledge_base_documents ADD COLUMN embedding vector(1536);
...
-- Create function for vector similarity search using cosine similarity
